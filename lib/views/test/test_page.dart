...
class _TestPageState extends State<TestPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('综合测试', style: TextStyle(fontSize: adaptive.Adaptive.sp(16))),
      ),
      body: Column(
        ...
        children: [
          // 顶部标题
          Padding(
            padding: EdgeInsets.fromLTRB(adaptive.Adaptive.w(16), adaptive.Adaptive.h(12), adaptive.Adaptive.w(16), adaptive.Adaptive.h(8)),
            child: Text(
              widget.videoTitle,
              style: TextStyle(fontSize: adaptive.Adaptive.sp(16), fontWeight: FontWeight.w600),
            ),
          ),
          // 题型配置滚动区域
          Expanded(
          ...
          // 底部操作栏
          Container(
            padding: EdgeInsets.fromLTRB(adaptive.Adaptive.w(16), adaptive.Adaptive.h(8), adaptive.Adaptive.w(16), adaptive.Adaptive.h(16)),
            decoration: BoxDecoration(
              color: Colors.white,
              border: Border(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FilledButton(
                    ...
                    child: _loading
                        ? SizedBox(
                            width: adaptive.Adaptive.r(18),
                            height: adaptive.Adaptive.r(18),
                            child: CircularProgressIndicator(
                              strokeWidth: 2,
                              color: colorScheme.onPrimary,
                            ),
                          )
                        : Text('开始', style: TextStyle(fontSize: adaptive.Adaptive.sp(15))),
                  ),
                ),
              ],
            ),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: adaptive.Adaptive.h(10)),
        ...children.expand((child) => [child, SizedBox(height: adaptive.Adaptive.h(8))]),
      ],
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          width: adaptive.Adaptive.r(28),
          height: adaptive.Adaptive.r(28),
          decoration: BoxDecoration(
            color: disabled
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // 底部操作栏
            Container(
              padding: EdgeInsets.fromLTRB(adaptive.Adaptive.w(4), adaptive.Adaptive.h(12), adaptive.Adaptive.w(4), adaptive.Adaptive.h(12)),
              decoration: BoxDecoration(
                color: Colors.white,
                border: Border(
                  top: BorderSide(color: colorScheme.outlineVariant.withValues(alpha: 0.3)),
              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                    height: adaptive.Adaptive.h(46),
                    child: Row(
                      children: [
                        Expanded(
                          child: OutlinedButton.icon(
                            onPressed: _submitted || _canSubmit() ? _goNext : null,
                            icon: Icon(AppIcons.chevronRight, size: adaptive.Adaptive.sp(16)),
                            label: Text(
                            ...
                            style: OutlinedButton.styleFrom(
                              ...
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(adaptive.Adaptive.r(10))),
                            ),
                          ),
                        ),
                        SizedBox(width: adaptive.Adaptive.w(12)),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(AppIcons.quiz, size: adaptive.Adaptive.sp(13), color: colorScheme.onSurfaceVariant),
  ...
  Widget _buildReorder() {
    ...
    return Column(
      ...
      children: [
        Text(
          prompt,
          style: TextStyle(fontSize: adaptive.Adaptive.sp(15), fontWeight: FontWeight.w600),
        ),
        SizedBox(height: adaptive.Adaptive.h(12)),
          ...
          children: [
            Expanded(
              child: OutlinedButton.icon(
                ...
                icon: Icon(AppIcons.backspace, size: adaptive.Adaptive.sp(14)),
                label: Text('撤销', style: TextStyle(fontSize: adaptive.Adaptive.sp(13), fontWeight: FontWeight.w500)),
                style: OutlinedButton.styleFrom(
            ...
            Expanded(
              child: OutlinedButton.icon(
                ...
                icon: Icon(AppIcons.delete, size: adaptive.Adaptive.sp(14)),
                label: Text('清空', style: TextStyle(fontSize: adaptive.Adaptive.sp(13), fontWeight: FontWeight.w500)),
                style: OutlinedButton.styleFrom(
                  foregroundColor: colorScheme.onSurfaceVariant,
                  side: BorderSide(color: colorScheme.outlineVariant.withValues(alpha: 0.3)),
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(adaptive.Adaptive.r(8))),
        ...
        if (_submitted && !_isCorrect)
          Padding(
            padding: EdgeInsets.only(top: adaptive.Adaptive.h(10)),
            child: Text(
              '正确答案：${answer.join(' ')}',
              style: TextStyle(
                fontSize: adaptive.Adaptive.sp(13),
        ...
        Row(
          children: [
                  ...
                  return Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        letterSpacing: adaptive.Adaptive.w(3),
                        color: textCol,
                        fontWeight: FontWeight.w600,
                      ),
                    ),
            ...
            GestureDetector(
              ...
              child: Container(
                width: adaptive.Adaptive.r(44),
                height: adaptive.Adaptive.r(44),
                decoration: BoxDecoration(
          ...
          Column(
            children: [
              GestureDetector(
                ...
                child: Container(
                  width: adaptive.Adaptive.r(56),
                  height: adaptive.Adaptive.r(56),
                  decoration: BoxDecoration(
                    color: _ttsPlayed
                  ...
                  child: _isPlayingTts
                      ? SizedBox(
                          width: adaptive.Adaptive.sp(24),
                          height: adaptive.Adaptive.sp(24),
                          child: CircularProgressIndicator(
                            strokeWidth: 2.5,
                            color: colorScheme.onPrimary,
                          ),
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            '（可多选）',
            style: TextStyle(fontSize: adaptive.Adaptive.sp(13), color: colorScheme.primary),
          ),
        ),
        Expanded(
          child: ListView.separated(
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Container(
                        width: adaptive.Adaptive.r(22),
                        height: adaptive.Adaptive.r(22),
                        alignment: Alignment.center,
                        decoration: BoxDecoration(
                          color: selected
                              ? colorScheme.primary
      ...
      children: [
          ...
          Column(
            children: [
              ...
              Text(
                refText,
                style: TextStyle(
                  fontSize: type == 'word_pron' ? adaptive.Adaptive.sp(24) : adaptive.Adaptive.sp(18),
                  fontWeight: FontWeight.w600,
                  color: colorScheme.onSurface,
                ),
                textAlign: TextAlign.center,
        ...
        Center(
          child: GestureDetector(
            ...
            child: Container(
              width: adaptive.Adaptive.r(80),
              height: adaptive.Adaptive.r(80),
              decoration: BoxDecoration(
                color: isRecording
                    ? AppColors.error
              ...
              child: isRecording
                  ? Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(AppIcons.mic, size: adaptive.Adaptive.sp(28), color: AppColors.surface),
                  ...
                  : Icon(AppIcons.mic, size: adaptive.Adaptive.sp(32), color: colorScheme.onPrimary),
            ),
          ),
        ),
        SizedBox(height: adaptive.Adaptive.h(10)),
...
child: Container(
padding: EdgeInsets.symmetric(horizontal: adaptive.Adaptive.w(12), vertical: adaptive.Adaptive.h(12)),
decoration: BoxDecoration(
color: bg,
borderRadius: BorderRadius.circular(adaptive.Adaptive.r(12)),
