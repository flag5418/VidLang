...
class _PlayerPageState extends ConsumerState<PlayerPage> with WidgetsBindingObserver {
  ...
  Widget _topBtn(IconData icon, VoidCallback onTap, {bool active = false}) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon, color: active ? AppColors.primary : Colors.white, size: t ? 30 : 22),
      ),
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            children: [
              // Left: time + playback controls grouped
              Text(
                _fmtDuration(s.position),
                style: TextStyle(color: Colors.white54, fontSize: t ? 13 : 10),
              ),
              Text(
                ' / ',
                style: TextStyle(color: Colors.white38, fontSize: t ? 12 : 10),
              ),
              Text(
              ...
              // Prev
              _smallCtrl(Icons.skip_previous_rounded, (hs && (idx ?? 0) > 0) ? () => n.previousSentence() : null, t),
              ...
              // Next
              _smallCtrl(Icons.skip_next_rounded, (hs && (idx ?? 0) < sl.length - 1) ? () => n.nextSentence() : null, t),

              const Spacer(),

              // Feature text buttons on right
              _featureTextBtn(
  ...
  Widget _smallCtrl(IconData icon, VoidCallback? onTap, bool t) {
    return IconButton(
      icon: Icon(icon, color: onTap != null ? Colors.white : Colors.white24, size: t ? 22 : 18),
      onPressed: onTap,
      padding: EdgeInsets.zero,
      constraints: BoxConstraints(minWidth: t ? 36 : 30, minHeight: t ? 36 : 30),
    );
  }

  Widget _featureTextBtn(String label, bool active, VoidCallback? onTap, bool t) {
    return GestureDetector(
      onTap: onTap,
      child: Text(
        label,
        ...
        Container(
          ...
          child: Row(
            children: [
              Text(
                '视频列表',
                style: TextStyle(color: Colors.white, fontSize: t ? 22 : 17, fontWeight: FontWeight.bold),
              ),
              const Spacer(),
              Text(
                '共 ${list.length} 集',
                style: TextStyle(color: Colors.white54, fontSize: t ? 16 : 14),
              ),
            ],
          ),
        ),
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text('暂无可播视频', style: TextStyle(color: Colors.white38)),
                    ],
                  ),
                )
              : ListView.builder(
  ...
  Widget _toggleGroup(List<String> opts, int ai, void Function(int) onTap) {
    return Container(
      decoration: BoxDecoration(color: AppColors.surfaceElevated, borderRadius: BorderRadius.circular(10)),
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Text(
                  opts[i],
                  textAlign: TextAlign.center,
                  style: TextStyle(color: a ? Colors.white : Colors.white54, fontSize: 14, fontWeight: a ? FontWeight.bold : FontWeight.normal),
                ),
              ),
            ),
          );
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text('小', style: TextStyle(color: Colors.white54, fontSize: 13)),
              Text(
                '${_subtitleFontSize.toInt()}',
                style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold),
              ),
              Text('大', style: TextStyle(color: Colors.white54, fontSize: 13)),
            ],
          ),
          SliderTheme(
            data: SliderThemeData(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (sub != null) Text(sub, style: TextStyle(color: Colors.white38, fontSize: 12)),
              ],
            ),
          ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                '跟读',
                style: TextStyle(color: Colors.white, fontSize: t ? 22 : 18, fontWeight: FontWeight.bold),
              ),
              const SizedBox(height: 12),
              ...
              if (cs != null)
                Container(
                  ...
                  child: Text(
                    cs.content,
                    style: TextStyle(color: Colors.white, fontSize: t ? 20 : 16, fontWeight: FontWeight.w500),
                    textAlign: TextAlign.center,
                  ),
                ),
              ...
              if (cs != null && cs.contentTranslate != null && cs.contentTranslate!.isNotEmpty)
                Padding(
                  ...
                  child: Text(
                    cs.contentTranslate!,
                    style: TextStyle(color: AppColors.playerSubtitleTranslate, fontSize: t ? 16 : 13),
                    textAlign: TextAlign.center,
                  ),
                ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(Icons.replay_rounded, color: AppColors.primary, size: t ? 22 : 18),
                          const SizedBox(width: 6),
                          Text(
                            '重播本句',
...
class _VideoListItemState extends ConsumerState<_VideoListItem> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          v.name,
                          style: TextStyle(color: Colors.white, fontSize: t ? 16 : 14, fontWeight: cur ? FontWeight.bold : FontWeight.w500),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                        ),
                        SizedBox(height: 4),
                        Row(
                          children: [
                            ...
                            Text(
                              v.durationString,
                              style: TextStyle(color: Colors.white38, fontSize: t ? 13 : 11),
                            ),
                            if (v.hasSubtitles) ...[
                              SizedBox(width: 8),
  ...
  Widget _placeholder(bool t) {
    return Center(
      child: Icon(Icons.movie_outlined, size: t ? 28 : 24, color: Colors.white24),
    );
  }
}
