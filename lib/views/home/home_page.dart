...
class _HomePageState extends ConsumerState<HomePage> {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Padding(
                padding: EdgeInsets.only(left: adaptive.Adaptive.w(4)),
                child: Text(
                  '最近学习',
                  style: TextStyle(
  ...
  Widget _buildStatItem({
    ...
    required AppColorsData colorScheme,
  }) {
    return Expanded(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: adaptive.Adaptive.sp(18), color: color),
          SizedBox(height: adaptive.Adaptive.h(4)),
          Text(
            value,
            style: TextStyle(
  ...
  Widget _buildStatDivider(AppColorsData colorScheme) {
    return Container(
      width: 1,
      height: 32,
  ...
  Widget _buildRecentList(
    ...
    if (_recentResources.isEmpty) {
      return Container(
        width: double.infinity,
        padding: EdgeInsets.symmetric(
          vertical: adaptive.Adaptive.h(24),
        ),
        decoration: BoxDecoration(
          color: surfaceColor,
          borderRadius: BorderRadius.circular(adaptive.Adaptive.r(12)),
  ...
  // 视频/音频详情
  Widget _buildVideoDetail(RecentResource resource, AppColorsData colorScheme) {
