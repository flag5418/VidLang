...
class AppShadows {
  ...
  /// 小阴影 - 轻微浮起效果
  /// 
  /// color: rgba(59, 110, 255, 0.05)
  /// blur: 12px
  /// offset: (0, 4)
  /// 用于：按钮、输入框
  static const List<BoxShadow> sm = [
    BoxShadow(
      color: Color(0x0D3B6EFF),
      blurRadius: 12,
      offset: Offset(0, 4),
    ),
  ];
  ...
  /// 中阴影 - 卡片悬浮效果
  /// 
  /// color: rgba(59, 110, 255, 0.06)
  /// blur: 24px
  /// offset: (0, 10)
  /// 用于：卡片、弹窗
  static const List<BoxShadow> md = [
    BoxShadow(
      color: Color(0x103B6EFF),
      blurRadius: 24,
      offset: Offset(0, 10),
    ),
  ];
  ...
  /// 大阴影 - 模态框效果
  /// 
  /// color: rgba(59, 110, 255, 0.08)
  /// blur: 40px
  /// offset: (0, 16)
  /// 用于：模态框、大卡片
  static const List<BoxShadow> lg = [
    BoxShadow(
      color: Color(0x143B6EFF),
      blurRadius: 40,
      offset: Offset(0, 16),
    ),
  ];
