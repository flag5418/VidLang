  ...
  Widget build(BuildContext context) {
    return Builder(
      builder: (context) => Column(
        ...
        children: [
          ShimmerCard(height: adaptive.Adaptive.h(100), borderRadius: adaptive.Adaptive.r(14)),
          SizedBox(height: adaptive.Adaptive.h(10)),
          ShimmerCard(height: adaptive.Adaptive.h(16), borderRadius: adaptive.Adaptive.r(4)),
          SizedBox(height: adaptive.Adaptive.h(6)),
          ShimmerCard(
            height: adaptive.Adaptive.h(12),
            width: adaptive.Adaptive.w(120),
            borderRadius: adaptive.Adaptive.r(4),
          ),
        ],
      ),
    );
